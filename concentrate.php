...
<head>
    ...
    <title>Concentrate con colores</title>
</head>
<body>
    ...
    <div style="margin: 60px auto;  width: 300px; font-size: 35px;">
     <section class="section1">
            <h1>Concentrate con colores</h1>
        </section>
       </div>
    <main>
        <table>
            <tr>
                <td class="card1"><button id="0" onclick="Dest(0)"></button></td>
                <td class="card1"><button id="1" onclick="Dest(1)"></button></td>
                <td class="card2"><button id="2" onclick="Dest(2)"></button></td>
                <td class="card2"><button id="3" onclick="Dest(3)"></button></td>
            </tr>
